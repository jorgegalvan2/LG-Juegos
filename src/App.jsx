        ...
        <footer className="container-fluid BrandColor ">
            <div className="row">
                <ul className="text-center text-light ulDecoration no-bullets">
                    <li className="mt-4">JG Juegos digitales</li>
                    <li className="mt-4">Contacto</li>
                    <li className="mt-4"><a target="_blank" href="https://www.instagram.com/jgjuegosdigitales/?hl=en" className="text-light"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <li className="mt-4"><a target="_blank" href="https://wa.me/message/6PSH46QCW4OTP1" className="text-light"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
